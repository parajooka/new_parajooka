...
public class SendSMS {
	public boolean sendMMS(String phone_number, String message) {
		String api_key = "NCSX6WN7XF0XIY8D";
	    String api_secret = "8ZDGLCZE6LDJPCEZTJRAO8QMNWGYKQ9N";
	    Message coolsms = new Message(api_key, api_secret);

	    // 4 params(to, from, type, text) are mandatory. must be filled
	    HashMap<String, String> params = new HashMap<String, String>();
	    params.put("to", phone_number); // 수신번호
	    params.put("from", "07088159665"); // 발신번호
    ...
    public boolean sendSMS(String phone_number, String message) {
		String api_key = "NCSX6WN7XF0XIY8D";
	    String api_secret = "8ZDGLCZE6LDJPCEZTJRAO8QMNWGYKQ9N";
	    Message coolsms = new Message(api_key, api_secret);
