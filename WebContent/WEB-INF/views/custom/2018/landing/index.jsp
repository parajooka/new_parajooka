		...
		<div class="money-back">
			...
			<div class="money-content">
				...
				<p class="money-view">
					...
					단순한 디자인이 아름답거나, 기술적으로 훌륭하다고 해서 되는 게 아니거든요.<br>
					온라인 세상은 소비자와의 심리싸움입니다.
				</p>
			</div>
		</div>
	</div>
	...
	<div class="info-section">
		<div class="info-container">
			...
			<div class="info-box">
				...
				<p class="info-view">
					당신의 높은 수준을 맞춰줄 에이전시를 찾고 있겠죠.<br>
					장담컨대 더 찾아봤자 웨이스트 포 타임입니다.<br>
	...
	<div class="human-section">
		<div class="human-container">
			...
			<div class="human-box">
				<div class="human-sh">
					<p class="human-title">
						지금 보고 계신 웹이 별로 마음에<br>안 든다면 큰일입니다.<br>당신이 뒤처져있다는 신호입니다.
					</p>
					<p class="human-view">
						설명하자면 꽤나 철학적인 이야기를 해야 해요.. 하지만 써봤자 당신은 읽지 않을 테고 또<br>
						얼마나 비싸게 받으려고 이렇게 골 아픈 소리를 하는 거지? 하며 지레 겁먹으실 수도 있으니<br>
						어린이가 어른을 이해 못 하듯, 당신이 모르는 뭔가 있다는 것 정도만 알아두세요.
					</p>
				</div>
			</div>
		</div>
