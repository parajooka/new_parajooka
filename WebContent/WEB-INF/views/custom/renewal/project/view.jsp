...
<div class="project_before">
	<a href="/custom/board/index?type=${thisMenu.menu_type}&menu_idx=${thisMenu.menu_idx}"><img style="width: 26px; margin-right: 10px;" src="/resources/common/img/backarrow.png">Back to Project</a>
</div>
...
$(window).on("resize", function() {
	$(".project_before").css("margin-left", "-"+ $(".project_before").width()/2 + "px");
});
