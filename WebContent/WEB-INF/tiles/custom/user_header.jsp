...
<meta property="og:url" content="http://para-jooka.kr">
<meta property="og:url" content="http://para-jooka.co.kr">
<meta property="og:url" content="http://para-jooka.online">
<meta property="og:title" content="${homepage.name}">  
<meta property="og:type" content="website">
<meta property="og:image" content="/res/img/admin/homepage/${homepage.favicon}">
<meta property="og:description" content="${homepage.info}">
<title>${homepage.name}</title>
<!-- favicon -->
<link rel="shortcut icon" href="/res/img/admin/homepage/${homepage.favicon}">
<!-- 기본 스타일시트 로딩 -->
<link rel="stylesheet" type="text/css" href="/resources/common/css/jquery-ui.min.css" />
<link rel="stylesheet" type="text/css" href="/resources/common/css/paging.css" />
<link rel="stylesheet" type="text/css" href="/resources/common/css/basic.css" />
...
<script  src="/resources/common/js/basic.js"></script>
